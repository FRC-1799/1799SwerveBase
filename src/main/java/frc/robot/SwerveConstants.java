...
public class SwerveConstants {
    public static class shared{
        ...
        public static final SwerveModuleConstantsFactory m_constantsCreator =
    ...
    public static class frontRight{
        ...
        public static final SwerveModuleConstants ModuleConstants = shared.m_constantsCreator.createModuleConstants(driveID, turnID,cancoderId, canCoderOffset, Xoffset, Yoffset, driveInverted);
